...
impl<N: Network> Serialize for CompactBatchHeader<N> {
    #[inline]
    fn serialize<S: Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        match serializer.is_human_readable() {
            true => {
                let mut header = serializer.serialize_struct("CompactBatchHeader", 7)?;
                ...
                header.serialize_field("transmission_ids_map", &self.transmission_ids_map)?;
...
impl<'de, N: Network> Deserialize<'de> for CompactBatchHeader<N> {
    #[inline]
        ...
        match deserializer.is_human_readable() {
            true => {
                ...
                let batch_header = Self::from(
                    ...
                    DeserializeExt::take_from_value::<D>(&mut header, "transmission_ids_map")?,
...
mod tests {
        ...
        T::Err: Debug,
    {
        ...
        // Deserialize
        assert_eq!(expected, T::from_str(expected_string).unwrap_or_else(|err| panic!("FromStr: {err:?}")));
