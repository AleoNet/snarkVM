...
use snarkvm_dpc::{
    testnet1::Testnet1 as Testnet1Network,
    CommitmentsTree,
...
impl Environment for Testnet1 {
    ...
    type Network = Testnet1Network;
    type SerialNumbersTree = SerialNumbersTree<Self::Network>;

    fn commitments_tree() -> &'static Self::CommitmentsTree {
        static TREE: OnceCell<<Testnet1 as Environment>::CommitmentsTree> = OnceCell::new();
        TREE.get_or_init(|| {
    ...
    fn serial_numbers_tree() -> &'static Self::SerialNumbersTree {
        static TREE: OnceCell<<Testnet1 as Environment>::SerialNumbersTree> = OnceCell::new();
        TREE.get_or_init(|| {
