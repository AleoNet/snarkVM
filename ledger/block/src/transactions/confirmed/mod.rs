...
pub mod test_helpers {
    ...
    pub(crate) fn sample_accepted_deploy(
        ...
        let tx = crate::transaction::test_helpers::sample_deployment_transaction(private_fee, rng);
    ...
    pub(crate) fn sample_accepted_execute(
        ...
        let tx = crate::transaction::test_helpers::sample_execution_transaction_with_fee(private_fee, rng);
        // Return the confirmed transaction.
    ...
    pub(crate) fn sample_rejected_deploy(
        ...
        let fee_transaction = match private_fee {
        ...
        let rejected = crate::rejected::test_helpers::sample_rejected_deployment(private_fee, rng);
    ...
    pub(crate) fn sample_rejected_execute(
        ...
        let rejected = crate::rejected::test_helpers::sample_rejected_execution(private_fee, rng);
    ...
    pub(crate) fn sample_confirmed_transactions() -> Vec<ConfirmedTransaction<CurrentNetwork>> {
        ...
        vec![
            ...
            sample_accepted_deploy(Uniform::rand(rng), rng.gen(), rng),
            sample_accepted_execute(Uniform::rand(rng), rng.gen(), rng),
            sample_rejected_deploy(Uniform::rand(rng), rng.gen(), rng),
            sample_rejected_execute(Uniform::rand(rng), rng.gen(), rng),
        ]
    }
}
