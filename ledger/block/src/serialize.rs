    ...
    fn serialize<S: Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        match serializer.is_human_readable() {
            true => {
                ...
                block.serialize_field("batch_certificate", &self.batch_certificate)?;
                block.serialize_field("previous_certificates", &self.previous_certificates)?;
                block.end()
            }
        ...
        match deserializer.is_human_readable() {
            true => {
                ...
                let block = Self::from(
                    ...
                    DeserializeExt::take_from_value::<D>(&mut block, "batch_certificate")?,
                    DeserializeExt::take_from_value::<D>(&mut block, "previous_certificates")?,
                )
