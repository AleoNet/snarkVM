...
fn test_uint32_from_bytes_be() {
    ...
    for _ in 0..1000 {
        ...
        let b = UInt32::from_bytes_be(v.clone(), cs.ns(|| "from_bytes_be_gadget"))
            .expect("failed to create a UInt32 from a byte");
...
fn test_uint32_from_bytes_le() {
    ...
    for _ in 0..1000 {
        ...
        let b = UInt32::from_bytes_le(v.clone(), cs.ns(|| "from_bytes_le_gadget"))
            .expect("failed to create a UInt32 from a byte");
