...
fn test_int8_from_bytes_be() {
    ...
    for _ in 0..1000 {
        ...
        let b = Int8::from_bytes_be(&v, cs.ns(|| "from_bytes_be_gadget")).expect("failed to create a Int8 from a byte");
...
fn test_int8_from_bytes_le() {
    ...
    for _ in 0..1000 {
        ...
        let b = Int8::from_bytes_le(&v, cs.ns(|| "from_bytes_le_gadget")).expect("failed to create a Int8 from a byte");
