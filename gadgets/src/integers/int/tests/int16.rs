...
fn test_int16_from_bytes_be() {
    ...
    for _ in 0..1000 {
        ...
        let b = Int16::from_bytes_be(v.clone(), cs.ns(|| "from_bytes_be_gadget"))
            .expect("failed to create a Int16 from a byte");
...
fn test_int16_from_bytes_le() {
    ...
    for _ in 0..1000 {
        ...
        let b = Int16::from_bytes_le(v.clone(), cs.ns(|| "from_bytes_le_gadget"))
            .expect("failed to create a Int16 from a byte");
