...
fn test_int128_from_bytes_be() {
    ...
    for _ in 0..1000 {
        ...
        let b = Int128::from_bytes_be(v.clone(), cs.ns(|| "from_bytes_be_gadget"))
            .expect("failed to create a Int128 from a byte");
...
fn test_int128_from_bytes_le() {
    ...
    for _ in 0..1000 {
        ...
        let b = Int128::from_bytes_le(v.clone(), cs.ns(|| "from_bytes_le_gadget"))
            .expect("failed to create a Int128 from a byte");
