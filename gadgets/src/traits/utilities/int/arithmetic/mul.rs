...
macro_rules! mul_int_impl {
    ($($gadget: ident)*) => ($(
        ...
        impl Mul for $gadget {
            ...
            fn mul<F: PrimeField, CS: ConstraintSystem<F>>(&self, mut cs: CS, other: &Self) -> Result<Self, Self::ErrorType> {
                // pseudocode:
                //
                // res = 0;
                ...
                let size = <$gadget as Number>::SIZE * 2;
                ...
                result_bits.truncate(<$gadget as Number>::SIZE);
