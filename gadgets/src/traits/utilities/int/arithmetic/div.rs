    ...
    ($($gadget:ident),*) => ($(
        impl<F: PrimeField> Div<F> for $gadget {
            ...
            fn div<CS: ConstraintSystem<F>>(
                ...
                let min = Self::constant(<$gadget as Integral>::IntegerType::MIN);
                ...
                let mut index = <$gadget as Integral>::SIZE - 1 as usize;
                let mut bit_value = (1 as <$gadget as Integral>::IntegerType) << ((index - 1) as <$gadget as Integral>::IntegerType);
