...
mod tests {
    ...
    fn generate_random_binding_signature<C: CommitmentScheme, R: Rng>(
        ...
        for input_amount in input_amounts {
            ...
            let value_commitment = value_comm_pp.commit(&input_amount.to_le_bytes(), &value_commit_randomness).unwrap();
        ...
        for output_amount in output_amounts {
            ...
            let value_commitment =
                value_comm_pp.commit(&output_amount.to_le_bytes(), &value_commit_randomness).unwrap();
