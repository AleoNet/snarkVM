...
mod bls12_377 {
    ...
    fn hash_bls12_377_g2() {
        ...
        assert_eq!(g2.x.c0.to_repr().as_ref(), [
            9329452611231846015,
            8792950918801334804,
            4523229430185034581,
        ...
        assert_eq!(g2.x.c1.to_repr().as_ref(), [
            1376524554983280488,
        ...
        assert_eq!(g2.y.c0.to_repr().as_ref(), [
            8721605417431851631,
            2728844593816855904,
        ...
        assert_eq!(g2.y.c1.to_repr().as_ref(), [
            2375843859815909437,
            1458086711624452503,
