...
mod bls12_377 {
    ...
    fn hash_bls12_377_g1() {
        ...
        assert_eq!(
            g1.x.to_string(),
            "74043643737953954445837721217321957512753691120262361950112069307233172627234232635736694518632774586903449475895"
        );
        assert_eq!(
            g1.y.to_string(),
            "475890735614386331806216012673415025616764851651524824695139553413441593942813660858704892862335035842553512392929"
        );
        assert_eq!(
    ...
    fn hash_bls12_377_g2() {
        ...
        assert_eq!(
            g2.x.to_string(),
            "Fp2(8675600355291825360916463635111231415651789139955390703452322943018503867687929509188013348679329452611231846015 + 1166248842816419241824176798849550044456714240547651739356426446564995130716104060203219724072241376524554983280488 * u)"
        );
        assert_eq!(
            g2.y.to_string(),
            "Fp2(76035893883463787900282266749317306769880679455880335791588090059205303649427288445938168559678721605417431851631 + 11360544497382845311183621525270212659156002841124120676921470451753823629421114580867116244525662375843859815909437 * u)"
        );
        assert_eq!(
