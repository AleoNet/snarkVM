    ...
    MM: MarlinMode,
{
    ...
    /// This is the main and only entrypoint for creating proofs as per Aleo's Marlin++ specification
    ...
    /// This is the main and only entrypoint for verifying proofs as per Aleo's Marlin++ specification
