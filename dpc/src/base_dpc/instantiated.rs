...
use crate::base_dpc::program::NoopCircuit;
use crate::base_dpc::program::ProgramLocalData;
use crate::base_dpc::transaction::DPCTransaction;
use crate::base_dpc::BaseDPCComponents;
use crate::base_dpc::LocalData as DPCLocalData;
...
use snarkvm_gadgets::algorithms::commitment::Blake2sCommitmentGadget;
use snarkvm_gadgets::algorithms::commitment::PedersenCompressedCommitmentGadget;
...
use snarkvm_gadgets::algorithms::snark::GM17VerifierGadget;
use snarkvm_gadgets::algorithms::snark::Groth16VerifierGadget;
