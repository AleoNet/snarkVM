...
mod tests {
    ...
    fn test_block_serde_json() {
        ...
        assert_eq!(1008500, candidate_string.len(), "Update me if serialization has changed");
    ...
    fn test_block_bincode() {
        ...
        assert_eq!(504090, expected_bytes.len(), "Update me if serialization has changed");
