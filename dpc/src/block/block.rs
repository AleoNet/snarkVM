...
mod tests {
    ...
    fn test_block_serde_json() {
        ...
        assert_eq!(1008043, candidate_string.len(), "Update me if serialization has changed");
    ...
    fn test_block_bincode() {
        ...
        assert_eq!(503945, expected_bytes.len(), "Update me if serialization has changed");
