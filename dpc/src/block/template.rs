...
mod tests {
    ...
    fn test_template_serde_json() {
        ...
        assert_eq!(1007051, candidate_string.len(), "Update me if serialization has changed");
    ...
    fn test_template_bincode() {
        ...
        assert_eq!(503230, expected_bytes.len(), "Update me if serialization has changed");
