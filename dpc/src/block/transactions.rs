...
mod tests {
    ...
    fn test_transactions_serde_json() {
        ...
        assert_eq!(1006058, candidate_string.len(), "Update me if serialization has changed");
    ...
    fn test_transactions_bincode() {
        ...
        assert_eq!(502866, expected_bytes.len(), "Update me if serialization has changed");
