...
mod tests {
    ...
    fn test_size() {
        {
            ...
            assert_eq!(787, transition_bytes.len(),);
        }
        {
    ...
    fn test_transition_serde_json() {
        ...
        assert_eq!(1737, candidate_string.len(), "Update me if serialization has changed");
    ...
    fn test_transition_bincode() {
        ...
        assert_eq!(787, expected_bytes.len(), "Update me if serialization has changed");
