...
mod tests {
    ...
    fn test_size() {
        {
            ...
            assert_eq!(882, transition_bytes.len(),);
        }
        {
    ...
    fn test_transition_serde_json() {
        ...
        assert_eq!(1867, candidate_string.len(), "Update me if serialization has changed");
    ...
    fn test_transition_bincode() {
        ...
        assert_eq!(882, expected_bytes.len(), "Update me if serialization has changed");
