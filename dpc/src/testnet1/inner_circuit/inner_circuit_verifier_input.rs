...
use crate::testnet1::{parameters::SystemParameters, AleoAmount, Testnet1Components};
...
impl<C: Testnet1Components> ToConstraintField<C::InnerField> for InnerCircuitVerifierInput<C>
where
