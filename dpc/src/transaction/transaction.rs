...
pub struct Transaction<C: Parameters> {
    ...
    /// Encrypted record of the new records generated by the transaction
...
impl<C: Parameters> ToBytes for Transaction<C> {
    ...
    fn write_le<W: Write>(&self, mut writer: W) -> IoResult<()> {
        ...
        for new_commitment in &self.commitments {
...
impl<C: Parameters> fmt::Debug for Transaction<C> {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(
            f,
            "Transaction {{ network_id: {:?}, digest: {:?}, inner_circuit_id: {:?}, serial_numbers: {:?}, commitments: {:?}, value_balance: {:?}, signatures: {:?}, proof: {:?}, memo: {:?} }}",
            self.network,
            self.ledger_digest,
            self.inner_circuit_id,
            self.serial_numbers,
