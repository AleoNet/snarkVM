...
fn test_account_new() {
    ...
    let account = Account::<DPC>::new(rng);
    println!("{:?}", account);
...
pub fn test_private_key_from_str() {
    ...
    let private_key = PrivateKey::<DPC>::from_str(private_key_string);
    println!("{:?}", private_key);
...
pub fn test_view_key_from_str() {
    ...
    let view_key = ViewKey::<DPC>::from_str(view_key_string);
    println!("{:?}", view_key);
...
pub fn test_address_from_str() {
    ...
    let address = Address::<DPC>::from_str(address_string);
