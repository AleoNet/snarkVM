...
fn field_element_to_bytes<C: Testnet2Components, CS: ConstraintSystem<C::OuterField>>(
    cs: &mut CS,
...
pub fn execute_outer_proof_gadget<C: Testnet2Components, CS: ConstraintSystem<C::OuterField>>(
    cs: &mut CS,
    // Parameters
