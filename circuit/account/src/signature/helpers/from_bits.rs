...
mod tests {
    ...
    fn test_from_bits_le_public() {
        check_from_bits_le(Mode::Public, 9, 0, 1879, 1885);
    }

    #[test]
    fn test_from_bits_le_private() {
        check_from_bits_le(Mode::Private, 9, 0, 1879, 1885);
    }
    ...
    fn test_from_bits_be_public() {
        check_from_bits_be(Mode::Public, 9, 0, 1879, 1885);
    }

    #[test]
    fn test_from_bits_be_private() {
        check_from_bits_be(Mode::Private, 9, 0, 1879, 1885);
    }
}
