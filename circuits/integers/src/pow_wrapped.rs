...
mod tests {
    ...
    // Lowered to 16, since we run (~6 * ITERATIONS) cases for most tests.
    const ITERATIONS: usize = 16;

    #[rustfmt::skip]
    fn check_pow_without_expected_numbers<I: IntegerType + RefUnwindSafe, M: Magnitude + RefUnwindSafe>(
        name: &str,
        first: I,
        second: M,
        mode_a: Mode,
    ...
    #[rustfmt::skip]
    fn run_exhaustive_test_without_expected_numbers<I: IntegerType + RefUnwindSafe, M: Magnitude + RefUnwindSafe>(
        mode_a: Mode,
        mode_b: Mode
    ) where
