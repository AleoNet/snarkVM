...
use snarkvm_circuits_environment::{traits::*, Environment, LinearCombination, Mode};
...
impl<E: Environment, I: IntegerType> IntegerTrait<Boolean<E>, I> for Integer<E, I> {}

impl<E: Environment, I: IntegerType> IntegerMagnitude<Boolean<E>, I, u8, U8<E>> for Integer<E, I> {}
impl<E: Environment, I: IntegerType> IntegerMagnitude<Boolean<E>, I, u16, U16<E>> for Integer<E, I> {}
impl<E: Environment, I: IntegerType> IntegerMagnitude<Boolean<E>, I, u32, U32<E>> for Integer<E, I> {}
...
mod test_utilities {
    ...
    use snarkvm_circuits_environment::{assert_circuit, assert_circuit_fails, Circuit, Eject, Environment};
