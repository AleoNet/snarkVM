...
use snarkvm_circuits_boolean::Boolean;
use snarkvm_circuits_environment::{traits::*, Environment, Mode};
use snarkvm_circuits_field::BaseField;
use snarkvm_circuits_scalar::Scalar;
use snarkvm_curves::{AffineCurve, TwistedEdwardsParameters};

#[cfg(test)]
use snarkvm_circuits_environment::assert_circuit;
...
impl<E: Environment> GroupTrait<Boolean<E>, Scalar<E>> for Affine<E> {}
...
mod tests {
    ...
    fn test_parser() {
        ...
        let (_, candidate) = Affine::<Circuit>::parse("6124_8679069_09631996143302_21072113214281104_6555821040_573308695_4291647607832_31_group", ).unwrap();
        ...
        let (_, candidate) = Affine::<Circuit>::parse("6124_8679069_09631996143302_21072113214281104_6555821040_573308695_4291647607832_31_group.constant", ).unwrap();
        assert_eq!(Primitive::from_str("6124867906909631996143302210721132142811046555821040573308695429164760783231").unwrap(), candidate.eject_value().to_x_coordinate());
        assert!(candidate.is_constant());
        ...
        let (_, candidate) = Affine::<Circuit>::parse("6124_8679069_09631996143302_21072113214281104_6555821040_573308695_4291647607832_31_group.public", ).unwrap();
        assert_eq!(Primitive::from_str("6124867906909631996143302210721132142811046555821040573308695429164760783231").unwrap(), candidate.eject_value().to_x_coordinate());
        assert!(candidate.is_public());
        ...
        let (_, candidate) = Affine::<Circuit>::parse("6124_8679069_09631996143302_21072113214281104_6555821040_573308695_4291647607832_31_group.private", ).unwrap();
        assert_eq!(Primitive::from_str("6124867906909631996143302210721132142811046555821040573308695429164760783231").unwrap(), candidate.eject_value().to_x_coordinate());
        assert!(candidate.is_private());
