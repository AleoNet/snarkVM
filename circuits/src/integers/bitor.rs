...
impl<E: Environment, I: IntegerType> BitOrAssign<&Integer<E, I>> for Integer<E, I> {
    fn bitor_assign(&mut self, other: &Integer<E, I>) {
        // Stores the bitwise OR of `self` or `other` in `self`.
        *self = Self {
            bits_le: self
                .bits_le
                .iter()
