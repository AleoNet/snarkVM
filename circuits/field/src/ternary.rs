...
mod tests {
    ...
    fn test_ternary() {
        ...
        {
            let a = BaseField::<Circuit>::new(Mode::Constant, UniformRand::rand(&mut test_rng()));
            let b = BaseField::<Circuit>::new(Mode::Constant, UniformRand::rand(&mut test_rng()));
        ...
        {
            let a = BaseField::<Circuit>::new(Mode::Public, UniformRand::rand(&mut test_rng()));
            let b = BaseField::<Circuit>::new(Mode::Private, UniformRand::rand(&mut test_rng()));
        ...
        {
            let a = BaseField::<Circuit>::new(Mode::Constant, UniformRand::rand(&mut test_rng()));
            let b = BaseField::<Circuit>::new(Mode::Public, UniformRand::rand(&mut test_rng()));
        ...
        {
            let a = BaseField::<Circuit>::new(Mode::Private, UniformRand::rand(&mut test_rng()));
            let b = BaseField::<Circuit>::new(Mode::Public, UniformRand::rand(&mut test_rng()));
