...
impl<E: Environment, I: IntegerType> Measure<dyn SubChecked<Integer<E, I>, Output = Integer<E, I>>> for Integer<E, I> {
    type Case = (Mode, Mode);
...
impl<E: Environment, I: IntegerType> Measure<dyn Sub<Integer<E, I>, Output = Integer<E, I>>> for Integer<E, I> {
    type Case = (Mode, Mode);

    fn count(input: &Self::Case) -> Count {
        <Self as Measure<dyn SubChecked<Integer<E, I>, Output = Integer<E, I>>>>::count(input)
    }
}
