    ...
    fn count(case: &Self::Case) -> Count {
        match I::is_signed() {
            true => match (case.0, case.1) {
                ...
                (Mode::Constant, _) => Count::is_and_gates_less_than(0, 0, I::BITS + 2, I::BITS + 4, 4 * I::BITS + 7),
                (_, Mode::Constant) => Count::is_and_gates_less_than(0, 0, I::BITS + 3, I::BITS + 5, 5 * I::BITS + 2),
                (_, _) => Count::is(0, 0, I::BITS + 4, I::BITS + 6, 5 * I::BITS + 11),
            },
            false => match (case.0, case.1) {
                (Mode::Constant, Mode::Constant) => Count::is(I::BITS, 0, 0, 0, 0),
                (Mode::Constant, _) | (_, Mode::Constant) => {
                    Count::is_and_gates_less_than(0, 0, I::BITS + 1, I::BITS + 3, 4 * I::BITS + 5)
                }
                (_, _) => Count::is(0, 0, I::BITS + 1, I::BITS + 3, 5 * I::BITS + 3),
            },
        }
    }
}
