...
mod tests {
    ...
    fn test_from_bits_le_public() {
        check_from_bits_le(Mode::Public, 2, 0, 256, 257);
    }

    #[test]
    fn test_from_bits_le_private() {
        check_from_bits_le(Mode::Private, 2, 0, 256, 257);
    }
    ...
    fn test_from_bits_be_public() {
        check_from_bits_be(Mode::Public, 2, 0, 256, 257);
    }

    #[test]
    fn test_from_bits_be_private() {
        check_from_bits_be(Mode::Private, 2, 0, 256, 257);
    }
}
