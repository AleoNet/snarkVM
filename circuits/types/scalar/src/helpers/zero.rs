...
impl<E: Environment> Metadata<dyn Zero<Boolean = Boolean<E>>> for Scalar<E> {
    type Case = ();
...
mod tests {
    ...
    fn test_zero() {
        ...
        Circuit::scope("Zero", || {
            ...
            assert_count!(Zero<Boolean>() => Scalar, &());
            assert_output_type!(Zero<Boolean>() => Scalar, (), candidate);
        });
    }
