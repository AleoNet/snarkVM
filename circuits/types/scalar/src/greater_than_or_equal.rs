...
impl<E: Environment> GreaterThanOrEqual<Scalar<E>> for Scalar<E> {
...
impl<E: Environment> Metadata<dyn GreaterThanOrEqual<Scalar<E>, Output = Boolean<E>>> for Scalar<E> {
    ...
    fn output_type(case: Self::Case) -> Self::OutputType {
        ...
        let less_than_output_type = output_type!(Self, LessThan<Self, Output = Boolean<E>>, (right, left));
    ...
    fn check_is_greater_than_or_equal(mode_a: Mode, mode_b: Mode) {
        for i in 0..ITERATIONS {
            ...
            Circuit::scope(&format!("{} {} {}", mode_a, mode_b, i), || {
                ...
                assert_count!(GreaterThanOrEqual(Scalar, Scalar) => Boolean, &case);
                assert_output_type!(GreaterThanOrEqual(Scalar, Scalar) => Boolean, case, candidate);
            });
            Circuit::reset();
        }
    }
