...
mod tests {
    ...
    fn test_sub_new() {
        ...
        let (_, sub_instruction) = Sub::new("sub bf.r3, bf.r2, bf.r1;").unwrap();
        assert_eq!(3, sub_instruction.rd.get_id());
        assert_eq!(2, sub_instruction.rs1.get_id());
        assert_eq!(1, sub_instruction.rs2.get_id());
        assert_eq!(RegisterType::BaseField, sub_instruction.rd.get_type());
        assert_eq!(RegisterType::BaseField, sub_instruction.rs1.get_type());
        assert_eq!(RegisterType::BaseField, sub_instruction.rs2.get_type());

        let (_, sub_instruction) = Sub::new("sub g.r3, g.r2, g.r1;").unwrap();
        assert_eq!(3, sub_instruction.rd.get_id());
        assert_eq!(2, sub_instruction.rs1.get_id());
        assert_eq!(1, sub_instruction.rs2.get_id());
        assert_eq!(RegisterType::Group, sub_instruction.rd.get_type());
        assert_eq!(RegisterType::Group, sub_instruction.rs1.get_type());
        assert_eq!(RegisterType::Group, sub_instruction.rs2.get_type());

        let (_, sub_instruction) = Sub::new("sub sf.r3, sf.r2, sf.r1;").unwrap();
        assert_eq!(3, sub_instruction.rd.get_id());
        assert_eq!(2, sub_instruction.rs1.get_id());
        assert_eq!(1, sub_instruction.rs2.get_id());
        assert_eq!(RegisterType::ScalarField, sub_instruction.rd.get_type());
        assert_eq!(RegisterType::ScalarField, sub_instruction.rs1.get_type());
        assert_eq!(RegisterType::ScalarField, sub_instruction.rs2.get_type());
    }
