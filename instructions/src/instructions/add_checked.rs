...
mod tests {
    ...
    #[test]
    fn test_add_checked_new() {
        // TODO (@pranav)
        //  This is just a sanity check. Need to construct a comprehensive test framework.
        let (_, add_checked_instruction) = AddChecked::new("addc u8.r3, u8.r2, u8.r1;").unwrap();
        assert_eq!(3, add_checked_instruction.rd.get_id());
        assert_eq!(2, add_checked_instruction.rs1.get_id());
        assert_eq!(1, add_checked_instruction.rs2.get_id());
        assert_eq!(RegisterType::U8, add_checked_instruction.rd.get_type());
        assert_eq!(RegisterType::U8, add_checked_instruction.rs1.get_type());
        assert_eq!(RegisterType::U8, add_checked_instruction.rs2.get_type());

        let (_, add_checked_instruction) = AddChecked::new("addc i8.r3, i8.r2, i8.r1;").unwrap();
        assert_eq!(3, add_checked_instruction.rd.get_id());
        assert_eq!(2, add_checked_instruction.rs1.get_id());
        assert_eq!(1, add_checked_instruction.rs2.get_id());
        assert_eq!(RegisterType::I8, add_checked_instruction.rd.get_type());
        assert_eq!(RegisterType::I8, add_checked_instruction.rs1.get_type());
        assert_eq!(RegisterType::I8, add_checked_instruction.rs2.get_type());
    }
