...
pub(crate) mod g1 {
    use snarkvm_curves::bls12_377::{Fr, G1Affine, G1Projective as G1};
    use snarkvm_models::curves::ProjectiveCurve;
...
pub(crate) mod g2 {
    use snarkvm_curves::bls12_377::{Fr, G2Affine, G2Projective as G2};
    use snarkvm_models::curves::ProjectiveCurve;
    use snarkvm_utilities::rand::UniformRand;
