    ...
    fn store(
        ...
        match register {
            Register::Locator(locator) => {
                ...
                match self.last_register == 0 {
                    true => ensure!(*locator == 0, "Out-of-order write operation at '{register}'"),
                    false => ensure!(*locator > self.last_register, "Out-of-order write operation at '{register}'"),
                };
