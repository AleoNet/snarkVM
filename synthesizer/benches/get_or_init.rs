...
//         program_string.push_str(&format!("get.or_init balances[0field] into r{i};"));
//     }
...
//         bench_all(
//             c,
//             &format!("get_or_init/1_program/1_execution/{num_commands}_commands"),
//             &[program],
//             &[],
//             &[],
//             &[("get_or_init_0.aleo".to_string(), "init".to_string(), vec![])],
//         );
//     }
// }
//
...
//         let executions = iter::repeat(("get_or_init_0.aleo".to_string(), "init".to_string(), vec![]))
//             .take(*num_executions)
//             .collect_vec();
//         // Bench the execution.
//         bench_all(
//             c,
//             &format!("get_or_init/1_program/{num_executions}_executions/{}_commands", NUM_COMMANDS.last().unwrap()),
//             &[program],
//             &[],
//             &[],
//             &executions,
...
//                 executions.push((format!("get_or_init_{i}.aleo"), "init".to_string(), vec![]));
//             }
//         }
//         // Bench the execution.
//         bench_all(
//             c,
//             &format!("get_or_init/{num_programs}_programs/{}_executions/{}_commands", NUM_EXECUTIONS.last().unwrap(), NUM_COMMANDS.last().unwrap()),
//             &initial_deployments,
//             &[],
//             &[],
//             &executions,
