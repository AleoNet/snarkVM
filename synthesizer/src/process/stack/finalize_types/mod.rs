...
use console::{
    network::prelude::*,
    program::{ElementType, Identifier, LiteralType, PlaintextType, Register, RegisterType, Struct},
};
...
impl<N: Network> FinalizeTypes<N> {
    ...
    pub fn get_type(
        ...
        // Retrieve the access path if the register is an access. Otherwise, return the type.
        ...
        for path_name in path.iter() {
            ...
            plaintext_type = match &plaintext_type {
                ...
                PlaintextType::Array(array_type) => match path_name {
                    ...
                    Access::Index(index) => array_type.index(**index)?,
                },
            }
        }
