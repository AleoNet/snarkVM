...
>
{
    ...
    fn evaluate(inputs: &[Value; NUM_OPERANDS]) -> Result<Vec<Value>>;
    ...
    fn output_types(inputs: &[ValueType; NUM_OPERANDS]) -> Result<Vec<ValueType>>;
}

/// Compute the absolute value of `first`, checking for overflow/underflow, and storing the outcome in `destination`.
pub type Abs<N> = UnaryLiteral<N, AbsOperation<N>, 1>;
...
pub type AbsWrapped<N> = UnaryLiteral<N, AbsWrappedOperation<N>, 1>;
...
pub type Add<N> = BinaryLiteral<N, AddOperation<N>, 1>;
...
pub type AddWrapped<N> = BinaryLiteral<N, AddWrappedOperation<N>, 1>;
...
pub type And<N> = BinaryLiteral<N, AndOperation<N>, 1>;
...
pub type Div<N> = BinaryLiteral<N, DivOperation<N>, 1>;
...
pub type Double<N> = UnaryLiteral<N, DoubleOperation<N>, 1>;
...
pub type GreaterThan<N> = BinaryLiteral<N, GreaterThanOperation<N>, 1>;
...
pub type GreaterThanOrEqual<N> = BinaryLiteral<N, GreaterThanOrEqualOperation<N>, 1>;
...
pub type Inv<N> = UnaryLiteral<N, InvOperation<N>, 1>;
...
pub type LessThan<N> = BinaryLiteral<N, LessThanOperation<N>, 1>;
...
pub type LessThanOrEqual<N> = BinaryLiteral<N, LessThanOrEqualOperation<N>, 1>;
...
pub type Modulo<N> = BinaryLiteral<N, ModuloOperation<N>, 1>;
...
pub type Mul<N> = BinaryLiteral<N, MulOperation<N>, 1>;
...
pub type MulWrapped<N> = BinaryLiteral<N, MulWrappedOperation<N>, 1>;
...
pub type Nand<N> = BinaryLiteral<N, NandOperation<N>, 1>;
...
pub type Neg<N> = UnaryLiteral<N, NegOperation<N>, 1>;
...
pub type Nor<N> = BinaryLiteral<N, NorOperation<N>, 1>;
...
pub type Not<N> = UnaryLiteral<N, NotOperation<N>, 1>;
...
pub type Or<N> = BinaryLiteral<N, OrOperation<N>, 1>;
...
pub type Pow<N> = BinaryLiteral<N, PowOperation<N>, 1>;
...
pub type PowWrapped<N> = BinaryLiteral<N, PowWrappedOperation<N>, 1>;
...
pub type Rem<N> = BinaryLiteral<N, RemOperation<N>, 1>;
...
pub type RemWrapped<N> = BinaryLiteral<N, RemWrappedOperation<N>, 1>;
...
pub type Shl<N> = BinaryLiteral<N, ShlOperation<N>, 1>;
...
pub type ShlWrapped<N> = BinaryLiteral<N, ShlWrappedOperation<N>, 1>;
...
pub type Shr<N> = BinaryLiteral<N, ShrOperation<N>, 1>;
...
pub type ShrWrapped<N> = BinaryLiteral<N, ShrWrappedOperation<N>, 1>;
...
pub type Square<N> = UnaryLiteral<N, SquareOperation<N>, 1>;
...
pub type SquareRoot<N> = UnaryLiteral<N, SquareRootOperation<N>, 1>;
...
pub type Sub<N> = BinaryLiteral<N, SubOperation<N>, 1>;
...
pub type SubWrapped<N> = BinaryLiteral<N, SubWrappedOperation<N>, 1>;
...
pub type Ternary<N> = TernaryLiteral<N, TernaryOperation<N>, 1>;
...
pub type Xor<N> = BinaryLiteral<N, XorOperation<N>, 1>;
