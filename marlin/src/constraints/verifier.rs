    ...
    PCG::CommitmentVar: ToConstraintFieldGadget<BaseField>,
{
    ...
    >(
        mut cs: CS,
        verifying_key_orig: &crate::marlin::CircuitVerifyingKey<TargetField, PC>,
    ...
    > {
        ...
        ////// ------- Equivalent up until this point -------- //////
        ...
        let rand_data = PCCheckRandomDataVar::<TargetField, BaseField> {
            opening_challenges: opening_challenges.clone(),
            opening_challenges_bits: opening_challenges_bits.clone(),
            batching_rands,
            batching_rands_bits,
        };
        ...
        // let mut native_vc: Vec<LinearCombination<TargetField>> = Vec::new();
        // AllocatedNonNativeFieldVar::limbs_to_value;

        // let native_commitments: Vec<Commitment<TargetField>> = Vec::new();
