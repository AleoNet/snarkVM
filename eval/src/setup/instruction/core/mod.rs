...
impl<'a, F: PrimeField, G: GroupType<F>, CS: ConstraintSystem<F>> EvaluatorState<'a, F, G, CS> {
    pub fn call_core(&mut self, name: &str, arguments: &[ConstrainedValue<F, G>]) -> Result<ConstrainedValue<F, G>> {
        match name {
            ...
            // to_bits_be
            bits::ADDRESS_TO_BITS_BE_CORE => self.call_core_address_to_bits_be(arguments),
            bits::BOOL_TO_BITS_BE_CORE => self.call_core_bool_to_bits_be(arguments),
            bits::CHAR_TO_BITS_BE_CORE => self.call_core_char_to_bits_be(arguments),
            bits::FIELD_TO_BITS_BE_CORE => self.call_core_field_to_bits_be(arguments),
            bits::GROUP_TO_BITS_BE_CORE => self.call_core_group_to_bits_be(arguments),
            bits::I8_TO_BITS_BE_CORE => self.call_core_i8_to_bits_be(arguments),
            bits::I16_TO_BITS_BE_CORE => self.call_core_i16_to_bits_be(arguments),
            bits::I32_TO_BITS_BE_CORE => self.call_core_i32_to_bits_be(arguments),
            bits::I64_TO_BITS_BE_CORE => self.call_core_i64_to_bits_be(arguments),
            bits::I128_TO_BITS_BE_CORE => self.call_core_i128_to_bits_be(arguments),
            bits::U8_TO_BITS_BE_CORE => self.call_core_u8_to_bits_be(arguments),
            bits::U16_TO_BITS_BE_CORE => self.call_core_u16_to_bits_be(arguments),
            bits::U32_TO_BITS_BE_CORE => self.call_core_u32_to_bits_be(arguments),
            bits::U64_TO_BITS_BE_CORE => self.call_core_u64_to_bits_be(arguments),
            bits::U128_TO_BITS_BE_CORE => self.call_core_u128_to_bits_be(arguments),
            // from_bits_le
