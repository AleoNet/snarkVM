...
pub const FINALIZE_ID_DEPTH: u8 = TRANSACTION_DEPTH + 4; // 4 for 16 finalize operations per transition.
/// The depth of the Merkle tree for finalize operations in a block.
pub const FINALIZE_OPERATIONS_DEPTH: u8 = TRANSACTIONS_DEPTH + 1;
