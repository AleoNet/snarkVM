...
impl<N: Network> FromBits for Identifier<N> {
    ...
    fn from_bits_le(bits_le: &[bool]) -> Result<Self> {
        ...
        match num_bytes <= max_bytes {
            ...
            true => Ok(Self(field, u8::try_from(num_bytes).unwrap())), // unwrap is okay here since size_in_data_bytes is at most 48 for our fields (and we never expect a length greater than 128).
