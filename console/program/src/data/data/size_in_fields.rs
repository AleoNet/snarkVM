...
impl<N: Network> Visibility for Data<N> {
    ...
    fn size_in_fields(&self) -> Result<u16> {
        ...
        match num_fields <= N::MAX_DATA_SIZE_IN_FIELDS as usize {
            ...
            true => Ok(u16::try_from(num_fields).or_halt_with::<N>("Data exceeds u16::MAX field elements.")),
            false => bail!("Data cannot exceed {} field elements.", N::MAX_DATA_SIZE_IN_FIELDS),
        }
    }
}
