...
impl<N: Network> Serialize for Data<N> {
    /// Serializes the `Data` into string or bytes.
...
impl<'de, N: Network> Deserialize<'de> for Data<N> {
    /// Deserializes the `Data` from a string or bytes.
...
mod tests {
    ...
    fn test_serde_json() -> Result<()> {
        ...
        for _ in 0..ITERATIONS {
            ...
            // Deserialize
            assert_eq!(expected, Data::from_str(expected_string)?);
