        ...
        match self {
            ...
            Self::Private(ciphertext) => {
                ...
                match ciphertext.len() == 1 {
                    ...
                    false => N::halt(format!("Internal error: ciphertext to_bits_le corrupted in record owner")),
                }
            }
        }
        bits_le
        ...
        match self {
            ...
            Self::Private(ciphertext) => {
                ...
                match ciphertext.len() == 1 {
                    ...
                    false => N::halt(format!("Internal error: ciphertext to_bits_be corrupted in record owner")),
                }
            }
        }
        bits_be
