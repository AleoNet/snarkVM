...
use snarkvm_gadgets::{
    fields::FpGadget,
    traits::utilities::{alloc::AllocGadget, boolean::Boolean, ToBytesGadget},
};
...
pub trait PrepareGadget<Unprepared, ConstraintF: PrimeField>: Sized {
    ...
    fn prepare<CS: ConstraintSystem<ConstraintF>>(cs: CS, unprepared: &Unprepared) -> Result<Self, SynthesisError>;
}
