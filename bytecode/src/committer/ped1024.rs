...
use crate::Program;
use snarkvm_circuits::{algorithms::Pedersen1024 as Pedersen1024Gadget, CommitmentScheme, Literal, ToBits};

const SETUP_MESSAGE: &str = "PedersenCommitment1024";
        ...
        if let Literal::Scalar(r) = randomness {
            match value {
                ...
                Literal::String(a) => {
                    ...
                    if bits.len() > 1024 {
                        P::halt("Invalid input size for Pedersen1024 commitment")
                    } else {
            ...
            P::halt("Invalid randomness type for Pedersen1024 commitment")
        }
    }
}
