...
mod tests {
    ...
    test_modes!(
        ...
        "1scalar",
        "3410659255728169898750086325142668660454277499884743925718334122641396433696group"
    );
    test_modes!(
        bool,
        CommitPed512,
        "true",
        "1scalar",
        "8207766802569749313965358209002972767463373090861921575237346864481239586165group"
    );
    test_modes!(
        field,
        CommitPed512,
    ...
    test_modes!(
        ...
        "2group",
        "1scalar",
        "3519938113542987815863571520168034497327536797778329828814521686527561395445group"
    );
    test_modes!(
        i8,
        CommitPed512,
    ...
    test_modes!(
        ...
        "1scalar",
        "2940548950498411855621626872089931006359864588508159785059887358076170748305group"
    );
    test_modes!(
        scalar,
        CommitPed512,
    ...
    fn test_composite() {
        ...
        let expected = Value::<P>::from_str(
            "8207766802569749313965358209002972767463373090861921575237346864481239586165group.private",
        );
