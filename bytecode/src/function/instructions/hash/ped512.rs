...
use snarkvm_circuits::{algorithms::Pedersen512, Hash as CircuitHash, Parser, ParserResult};
...
pub type HashPed512<P> = Hash<P, Pedersen512<<P as Program>::Aleo>>;

impl<P: Program> Opcode for HashPed512<P> {
...
impl<P: Program> Parser for HashPed512<P> {
    ...
    fn parse(string: &str) -> ParserResult<Self> {
        map(UnaryOperation::parse, |operation| Self {
            operation,
            hasher: Pedersen512::<P::Environment>::setup("PedersenCircuit0"),
        })(string)
    }
}

impl<P: Program> FromBytes for HashPed512<P> {
...
impl<P: Program> ToBytes for HashPed512<P> {
...
impl<P: Program> Into<Instruction<P>> for HashPed512<P> {
    /// Converts the operation into an instruction.
    fn into(self) -> Instruction<P> {
        Instruction::HashPed512(self)
    }
}
