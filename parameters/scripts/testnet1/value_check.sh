...
RUST_BACKTRACE=1 cargo run --release --example setup value_check testnet1 || exit

mv value_check.metadata ../../src/testnet1/resources
mv value_check.proving* ~/.aleo/resources
mv value_check.verifying ../../src/testnet1/resources
