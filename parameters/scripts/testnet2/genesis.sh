...
cargo run --release --example genesis testnet2 aleo1h47qwdqqv25gwp0fkxgnqvm7ykrz0ud2vaw2cj4ac68w8wq5vqqqv58jvr block_header.genesis transaction_1.genesis -- --nocapture || exit
