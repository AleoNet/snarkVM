...
use snarkvm_dpc::{testnet1::parameters::Testnet1Parameters, DPCError, InnerCircuit, Parameters};
...
pub fn main() {
    let (inner_snark_pk, inner_snark_vk) = setup::<Testnet1Parameters>().unwrap();
