...
impl<N: Network> Serialize for Batch<N> {
    #[inline]
...
impl<'de, N: Network> Deserialize<'de> for Batch<N> {
    #[inline]
    fn deserialize<D: Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        FromBytesDeserializer::<Self>::deserialize_with_size_encoding(deserializer, "batch")
    }
}
